  ...
  <body>
      <div class="card">
          <div class="card-header">
             <div class="container">
                 <div class="row">
                     <a name="" id="" class="btn btn-primary" href="create.php" role="button">Add task</a>
                 </div>
    ...
    <div class="container">    
        <h4>Manage Task</h4>
        <p class="form-text text-sucess">
                    you are logged in as <?php echo $_SESSION['name'];?>
                 </p> 
        <a name="" id="" class="btn btn-danger" href="logout.php" role="button">Log out</a>         
    <table class="table">
        <thead>
            <tr>
                <th>S.N</th>
